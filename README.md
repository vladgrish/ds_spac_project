...
We then tried using multiple generated features in various combinations, trying to predict several days ahead, training the model using different stocks data
